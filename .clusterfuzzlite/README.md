...
1. `.github/workflows/cflite_pr.yml`
   - Trigger: `pull_request` to `main` (with docs-only paths ignored) and
     `workflow_dispatch`.
   - Mode: `code-change`
   - Sanitizer: `address`
...
2. `.github/workflows/cflite_coverage.yml`
...
3. `.github/workflows/cflite_weekly.yml`
