...
- Avoid json-patch-x if you require a pure‑Python stack. [Pydantic v2](https://docs.pydantic.dev/latest/why/) depends on a compiled Rust extension ([`pydantic-core`](https://github.com/pydantic/pydantic-core)), which can limit compatibility with alternative runtimes, restricted environments, and platforms where native extensions are unavailable.
